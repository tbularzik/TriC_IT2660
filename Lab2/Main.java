...
class Lab2 {
  public void linkedList() {
    ...
    // example in our book.
    ListIterator<String> langIterator = progLanguages.listIterator();
  ...
  public void stack() {
    ...
    // search.
    int foundAtPosition = bookStack.search("Design Patterns");
    if (foundAtPosition > -1) {
      System.out.println("Book found at position: " + foundAtPosition);
    } else {
